...
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);/*! `julia` grammar compiled for Highlight.js 11.7.0 */
...
;hljs.registerLanguage("julia-repl",a)})();/*! `haskell` grammar compiled for Highlight.js 11.7.0 */
...
}),n,{begin:"->|<-"}]}}})();hljs.registerLanguage("haskell",e)})();/*! `plaintext` grammar compiled for Highlight.js 11.7.0 */
...
;hljs.registerLanguage("clojure",e)})();/*! `bash` grammar compiled for Highlight.js 11.7.0 */
...
;hljs.registerLanguage("rust",e)})();/*! `ruby` grammar compiled for Highlight.js 11.7.0 */
(()=>{var e=(()=>{"use strict";return e=>{
...
;hljs.registerLanguage("css",e)})();/*! `clojure-repl` grammar compiled for Highlight.js 11.7.0 */
(()=>{var e=(()=>{"use strict";return e=>({name:"Clojure REPL",contains:[{
className:"meta.prompt",begin:/^([\w.-]+|\s*#_)?=>/,starts:{end:/$/,
subLanguage:"clojure"}}]})})();hljs.registerLanguage("clojure-repl",e)})();/*! `prolog` grammar compiled for Highlight.js 11.7.0 */
...
contains:g.concat([{begin:/\.$/}])}}})();hljs.registerLanguage("prolog",n)})();/*! `lisp` grammar compiled for Highlight.js 11.7.0 */
(()=>{var e=(()=>{"use strict";return e=>{
